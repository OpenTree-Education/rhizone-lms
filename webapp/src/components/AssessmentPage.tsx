  ...
  return (
    <>
      <Box ml={10} mr={10}>
        ...
        <Typography mb={5}>
          Welcome to the assessment page! We are glad to have you here. This
          page is designed to help you keep track of your past and upcoming
          ...
          your learning journey, and we want to make sure you have easy access
          to all the information you need to stay on top of your progress.
          Please feel free to explore the page and let us know if you have any
          questions or feedback. We are here to help you succeed!
        </Typography>
        <Box>
