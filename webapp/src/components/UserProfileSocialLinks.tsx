...
const renderGitHubProfileLink = (
  ...
  return (
    <Grid item key={social_profile.profile_url}>
      <Tooltip title="GitHub">
        <IconButton
          component="a"
          href={social_profile.profile_url}
          target="_blank"
        >
...
const renderLinkedInProfileLink = (
  social_profile: SocialProfile
): JSX.Element | void => {
  if (social_profile.public === false) {
    return;
...
const renderTwitterProfileLink = (
  social_profile: SocialProfile
): JSX.Element | void => {
  if (social_profile.public === false) {
    return;
...
const renderDribbbleProfileLink = (
  social_profile: SocialProfile
): JSX.Element | void => {
  if (social_profile.public === false) {
    return;
      ...
      {profileList.map((social_profile: SocialProfile) => {
        switch (social_profile.network_name) {
          ...
          default:
            return (
              <a
                key={social_profile.profile_url}
                href={social_profile.profile_url}
              >
